...
class _MorningazkarState extends State<Morningazkar> {
  // ✅ القائمة الكاملة للأذكار (31 ذكر)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // ✅ تم تغيير الخلفية هنا لتدرج 3 ألوان
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Color(0xFF136A8A), // Top: الأصفر
                  Color(0xFF267871), // Middle: البرتقالي
                  Color(0xFF0f2027), // Bottom: الكحلي الغامق
                ],
              ),
            ),
          ),
